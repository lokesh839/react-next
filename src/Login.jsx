        ...
        <div class="flex items-center justify-center min-h-screen">
            <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
                ...
                <form action="">
                    ...
                    <button type="submit" className=" w-full bg-indigo-600 text-white p-3 rounded-mb hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500">singin</button>
                </form>
